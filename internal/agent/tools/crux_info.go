...
const CruxInfoToolName = "crux_info"

//go:embed crux_info.md
var cruxInfoDescription string

type CruxInfoParams struct{}

func NewCruxInfoTool(
	...
	return fantasy.NewAgentTool(
		CruxInfoToolName,
		cruxInfoDescription,
		func(ctx context.Context, _ CruxInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildCruxInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildCruxInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
