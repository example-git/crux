...
func TestCruxInfo_MinimalConfig(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/crux/crux.json",
		"/project/.crux/crux.json",
	)
	output := buildCruxInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/crux/crux.json")
	require.Contains(t, output, "/project/.crux/crux.json")
}

func TestCruxInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildCruxInfo(cfg, mgr, nil, nil, nil)
...
func TestCruxInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.crux",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.crux")
	require.Contains(t, output, "debug = true")
}

func TestCruxInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildCruxInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildCruxInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestCruxInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildCruxInfo(store, nil, nil, nil, nil)
...
func TestCruxInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "crux-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("crux-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildCruxInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "crux-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestCruxInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "crux-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestCruxInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestCruxInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
