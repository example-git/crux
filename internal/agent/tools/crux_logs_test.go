...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crux.log")
...
func TestNewCruxLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewCruxLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, CruxLogsToolName, tool.Info().Name)
}

func TestCruxLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runCruxLogs(logFile, CruxLogsParams{Lines: 3})
...
func TestCruxLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runCruxLogs(logFile, CruxLogsParams{Lines: 0})
...
func TestCruxLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runCruxLogs(logFile, CruxLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestCruxLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runCruxLogs("/nonexistent/path/crux.log", CruxLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestCruxLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crux.log")
	...
	result := runCruxLogs(logFile, CruxLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestCruxLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crux.log")
	...
	result := runCruxLogs(logFile, CruxLogsParams{Lines: 10})
...
func TestCruxLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runCruxLogs(logFile, CruxLogsParams{Lines: 1})
...
func TestCruxLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestCruxLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestCruxLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestCruxLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crux.log")
...
func TestCruxLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crux.log")
...
func TestCruxLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestCruxLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestCruxLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestCruxLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runCruxLogs(logFile, CruxLogsParams{Lines: 5})
...
func TestCruxLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
