...
// fully detached from Crux's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Crux's process
// group.
...
// from Crux's session and controlling terminal.
//
