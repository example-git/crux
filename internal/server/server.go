...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/agent/jobs/detach", c.handlePostWorkspaceAgentJobsDetach)
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/tasks/{tid}/restart", c.handlePostWorkspaceTaskRestart)
