...
func TestConnectionProbeResultValidation(t *testing.T) {
	for _, result := range []ConnectionProbeResult{
		...
		{Kind: ConnectionProbeNotProbed, Policy: ConnectionProbePolicyManifestHTTP200},
		{Kind: ConnectionProbeHTTPAttempt, Policy: ConnectionProbePolicyManifestHTTP200},
		{Kind: ConnectionProbeHTTPResponse, Policy: ConnectionProbePolicyManifestHTTP200, HTTPStatus: 503},
