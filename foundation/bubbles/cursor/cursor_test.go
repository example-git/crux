...
//     ["github.com/example-git/crux/foundation/bubbletea".Model.Update];
//  2. ["github.com/example-git/crux/foundation/bubbletea".handleCommands] is kept sufficiently busy that it does not receive and
...
//  5. ["github.com/example-git/crux/foundation/bubbletea".handleCommands] gets around to receiving and executing the original
//     closure.
//
