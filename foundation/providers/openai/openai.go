...
// Package openai provides an implementation of the Crux foundation runtime for OpenAI's language models.
package openai
...
func (o *provider) LanguageModel(_ context.Context, modelID string) (fantasy.LanguageModel, error) {
	...
	defaultUA := fantasy.DefaultUserAgent(fantasy.Version)
	resolved := fantasy.ResolveHeaders(o.options.headers, o.options.userAgent, defaultUA)
